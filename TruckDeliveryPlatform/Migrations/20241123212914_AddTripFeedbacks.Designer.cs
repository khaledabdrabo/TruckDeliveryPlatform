...
namespace TruckDeliveryPlatform.Migrations
{
    ...
    [Migration("20241123212914_AddTripFeedbacks")]
    partial class AddTripFeedbacks
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TripFeedback", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("CustomerCooperation")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("TruckDeliveryPlatform.Models.Bid", b =>
                {
                    ...
                    b.Property<decimal>("WaitingHourPrice")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("TruckDeliveryPlatform.Models.Job", b =>
                {
                    ...
                    b.Property<decimal>("EstimatedWaitingHours")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("TruckDeliveryPlatform.Models.SystemConfig", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            BaseFee = 50m,
                            CreatedAt = new DateTime(2024, 11, 23, 21, 29, 12, 855, DateTimeKind.Utc).AddTicks(4173),
